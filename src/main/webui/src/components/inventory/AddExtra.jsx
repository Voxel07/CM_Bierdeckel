                    ...
                    <FormikWithRef
                        ...
                        initialValues={
                            prductToModify ? {
                                ...
                                category: prductToModify.category || ''
                            } : {
                                description: '',
                                price: '',
                                stock: '',
                                ...
                                return (
                                    <Box sx={style}>
                                        <Typography variant="h5" sx={{ marginBottom: '24px', fontWeight: 600, color: '#1998a1', textTransform: 'uppercase', letterSpacing: '1px' }}>
                                            {action === "add" ? "Neues Extra hinzufügen" : "Extra aktualisieren"}
                                        </Typography>
                                        ...
                                        <Form style={{ display: 'block', width: '100%' }}>
                                            <Grid container spacing={2.5}>
                                                ...
                                                {/* Second Row: Kategorie */}
                                                <Grid xs={12}>
                                                    <Autocomplete
                                                        disablePortal
                                                        id="ac_category_update_product"
                                                        fullWidth
                                                        defaultValue={prductToModify ? pCategory.find(item => item.id === prductToModify.category) : null}
                                                        options={pCategory}
                                                ...
                                                {/* Third Row: Bestand and Verbraucht */}
                                                <Grid xs={6}>
                                                    <Field
                                                        autoComplete='off'
                                                        variant="outlined"
